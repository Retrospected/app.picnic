...
const PRIVATE = /^(address|street|house_?number(_ext)?|postcode|zip|city|first_?name|last_?name|name_of_customer|redacted_iban|iban|bank_id|account|phone(_number)?|e?mail|contact_email|state_token|user_id|customer_id|household_id|payment_option_account|lat|lng|latitude|longitude|auth|token|secret|password)$/i;
