...
function describeError(error, seen) {
    ...
    try {
        ...
        // Only the values this one sits inside can be circular, so the ones
        // already left behind are popped rather than remembered: a value
        // mentioned twice side by side is not a loop.
        const ancestors = [];
