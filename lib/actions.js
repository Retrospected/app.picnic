...
class actions extends BaseClass {
  ...
  async onInit() {
    ...
    this.homey.flow.getActionCard('add_product_by_id').registerRunListener(async (args) => {
      const productId = args["product_id"]
      this.homey.app.debug("Running action add_product_by_id with args: "+productId)
